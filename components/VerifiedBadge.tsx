...
export default function VerifiedBadge({ size = 20, style }: VerifiedBadgeProps) {
    return (
        <Svg
            width={size}
            height={size}
